...
(function() {
  ...
  // Critical CSS loading (dynamic baseurl support)
  const baseUrl = document.querySelector('meta[name="base-url"]')?.content || '';
  const criticalCSS = document.createElement('link');
  criticalCSS.rel = 'preload';
  criticalCSS.href = baseUrl + '/critical.css';
  ...
  criticalCSS.onerror = function() {
    // Silently fail if critical.css doesn't exist
    console.log('Critical CSS not found, continuing without it');
  };
